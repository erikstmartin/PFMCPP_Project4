...
void part3()
{
    ...
    std::cout << "The result of FloatType^4 divided by IntType is: " << ft.multiply( *ft.value ).multiply( static_cast<float>(ft) ).divide( it ) << std::endl;
...
struct Point
{
    Point(float xAxis, float yAxis) : x(xAxis), y(yAxis){}
